const bodyMail = (name, login, pass) => {
  return `<!DOCTYPE html>
  <html>
                                  ...
                                  <tr>
                                      <td>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                  <td align="left" style="padding: 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Senha: ${pass}</td>
                                              </tr>
                                              <tr>
                                                  <td align="left" style="padding: 25px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Agradecimento,<br>nosso time!</td>
                                              </tr>
                                          </table>
                                      </td>
                                  </tr>
